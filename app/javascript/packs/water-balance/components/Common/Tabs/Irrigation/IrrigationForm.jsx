  ...
  nonMetered = (values, basePath) => {
    ...
    return (
      <Fragment>
        ...
        {type == 'Turfgrass' && this.clearValues(['supplemental_irrigation', 'plant_density', 'exposure'], basePath, values)}
    ...
    return (
      <Fragment>
              ...
              <Grid item xs={12} key={index}>
                <ExpansionPanel style={expansionPanel} expanded={selectn(`${name}.name`)(values) !== undefined}>
                  <ExpansionPanelSummary>
                    ...
                    />
                    {values.irrigation && values.irrigation.length > 1 && (
                      <IconButton
                        style={{
                          padding: 'initial',
                          height: '40px',
        ...
        <Grid item xs={12} sm={4}>
          <Field validate={this.validRainFall} fullWidth required name='postal_code' component={MaterialInput} type='text' label='Zip Code' />
        </Grid>
        <Grid sm={12} />
        <Grid item xs={12} sm={4}>
          <Field
              ...
              <Grid container alignItems='flex-start' spacing={16}>
                <Grid item xs={12}>
                  <FormControlLabel
                    ...
                    control={<Field name='has_irrigation' component={Checkbox} indeterminate={values.has_irrigation === undefined} type='checkbox' />}
                  />
                </Grid>
                ...
                <Grid item xs={12}>
                  {values.has_irrigation === true && (
                    <Button style={{marginLeft: '10px'}} variant='contained' color='primary' onClick={() => push('irrigation', {})}>
                      Add Another Landscape Area
                    </Button>
                  )}
                  {values.has_irrigation === false || values.has_irrigation === undefined ? null : (
                    <Fragment>
